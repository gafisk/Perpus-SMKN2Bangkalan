...
if (isset($_GET['hapus'])) {
  ...
  $datas = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM transaksi INNER JOIN buku ON transaksi.id_buku = buku.id_buku WHERE id_transaksi = '$id_transaksi' AND status = 'Pinjam'"));
                    ...
                    <tbody>
                      <?php foreach ($datas as $data) : ?>
                        <tr>
                          ...
                          <td>
                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#data<?= $data['id_transaksi'] ?>">
                              Pengembalian
                            </button>
                            <div class="modal fade" id="data<?= $data['id_transaksi'] ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <table class="table">
                                      <tr>
                                        <td colspan="2" style="text-align: center;"> <strong> Keterangan Peminjam</strong>
                                        </td>
                                      </tr>
                                      <tr>
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    <a href="?kembali=<?= $data['id_transaksi'] ?>" onclick="confirm('Perhatikan Denda dan kembalikan Buku?')" type="button" class="btn btn-primary">Simpan</a>
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <!-- Button Satunya -->
                            <a href="?hapus=<?= $data['id_transaksi'] ?>" type="button" class="btn btn-danger btn-sm" onclick="confirm('Anda Yakin Ingin Menghapus Data?')">Hapus</a>
                          </td>
                        </tr>
                        <!-- Modal -->
                      <?php endforeach ?>
