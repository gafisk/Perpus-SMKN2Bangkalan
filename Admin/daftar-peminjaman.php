                      ...
                      <?php foreach ($datas as $data) : ?>
                        <tr>
                          ...
                          <td>
                              ...
                              <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    <a href="?kembali=<?= $data['id_transaksi'] ?>" onclick="return confirm('Perhatikan Denda dan kembalikan Buku?')" type="button" class="btn btn-primary">Simpan</a>
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <!-- Button Satunya -->
                            <a href="?hapus=<?= $data['id_transaksi'] ?>" type="button" class="btn btn-danger btn-sm" onclick="return confirm('Anda Yakin Ingin Menghapus Data?')">Hapus</a>
                          </td>
                        </tr>
                        <!-- Modal -->
                      <?php endforeach ?>
